...
// import rendizyLogo from 'figma:asset/57eefd69a2e74079e948ce1356622b7f42644fd5.png'; // CORREÇÃO: Comentado para evitar erro de build do Vercel (Rollup failed to resolve import)
