...
// import { StaysNetReservationAnalyzer } from './StaysNetReservationAnalyzer'; // Removido para evitar ReferenceError
...
export default function StaysNetIntegration() {
  ...
  // Importação dinâmica para evitar ReferenceError: Cannot access 'x' before initialization
  const StaysNetReservationAnalyzer = React.lazy(() => import('./StaysNetReservationAnalyzer').then(module => ({ default: module.StaysNetReservationAnalyzer })));
