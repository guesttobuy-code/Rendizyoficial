...
interface FinancialResidentialPricingStepProps {
  ...
  categories?: string[]; // 🆕 Modalidades selecionadas (short_term_rental, residential_rental, buy_sell)
}
...
export function FinancialResidentialPricingStep({
  ...
  // 🆕 Filtrar seções por modalidade
  // Se apenas compra e venda, não mostrar locação
  const isOnlyBuySell =
  ...
  const showRental = hasResidentialRental; // Apenas se tiver locação residencial
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* ================================================================ */}
      {/* 🆕 Apenas mostrar se modalidade incluir locação residencial */}
      {showRental && (
        <CollapsibleSection
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Valor base do aluguel cobrado mensalmente, sem incluir condomínio
              ou IPTU.
            </p>
          ...
          <div className="space-y-2">
            <Label htmlFor="securityDeposit">
              Valor da Caução/Depósito de Garantia
            </Label>
            <p className="text-xs text-gray-600">
              Valor solicitado como garantia no início do contrato (geralmente
              equivalente a 1-3 aluguéis).
            </p>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
                R$
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Taxa de condomínio mensal que o locatário deve pagar (quando
              aplicável).
            </p>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
      ...
      {showRental && (
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Qual índice será usado para reajustar o valor do aluguel
              anualmente?
            </p>
            <Select
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              A cada quantos meses o aluguel será reajustado pelo índice
              selecionado?
            </p>
            <div className="relative">
              <Input
      ...
      {/* ================================================================ */}
      {/* 🆕 Apenas mostrar se modalidade incluir compra e venda */}
      {showSale && (
        <CollapsibleSection
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Valor total de venda do imóvel. Este será o preço anunciado nos
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Há quantos anos o imóvel foi construído? (deixe em branco se for
              lançamento)
            </p>
            <div className="relative">
              <Input
      ...
      {showSale && (
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Marque [Sim] se o imóvel pode ser adquirido através de
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Marque [Sim] se você aceita trocar este imóvel por outro imóvel,
              carro ou outro bem.
            </p>
            <div className="flex gap-2">
              <Button
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Marque [Sim] se apenas sua imobiliária tem autorização para vender
              este imóvel.
            </p>
            <div className="flex gap-2">
              <Button
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600">
              Qual o percentual de comissão sobre a venda? (geralmente entre 5%
              e 8%)
            </p>
            <div className="relative">
              <Input
