...
// ============================================================================
// ⚠️ ESTA FUNCIONALIDADE ESTÁ FUNCIONANDO EM PRODUÇÃO - NÃO MODIFICAR SEM DESBLOQUEAR
// 
// ISOLAMENTO GARANTIDO:
// - ✅ Não depende de detalhes internos de outras cápsulas
// - ✅ Usa apenas APIs públicas (rotas registradas)
// - ✅ Não compartilha estado global mutável (usa Context API)
// - ✅ Tem suas próprias rotas isoladas
// 
// ANTES DE MODIFICAR:
// 1. ✅ Ler: FUNCIONALIDADES_CRITICAS.md
// 2. ✅ Verificar dependências: grep -r "AuthContext\|authService" .
// 3. ✅ Executar: npm run check:critical-routes
// 4. ✅ Testar isoladamente: npm run test:auth
// 
...
// - ✅ ProtectedRoute → Usa AuthContext para verificar autenticação
// - ✅ Todas as cápsulas → Usam AuthContext para obter user/organization
