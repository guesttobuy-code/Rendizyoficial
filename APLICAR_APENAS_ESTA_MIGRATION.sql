...
-- ============================================================================
-- 
-- ⚠️ IMPORTANTE: Aplique APENAS esta migration no SQL Editor do Supabase
-- Esta migration é independente e não depende das outras
-- ============================================================================
...
SELECT 
  table_name,
  CASE 
    WHEN table_name IN ('users', 'sessions', 'organizations') THEN '✅ CRÍTICA'
    ELSE '📋 Normal'
  END as importancia
