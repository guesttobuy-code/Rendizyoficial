-- ============================================================================
-- MIGRATION: Adicionar suporte a Access/Refresh Tokens (OAuth2)
-- Data: 2025-11-26
-- Versão: v1.0.103.1010
-- ============================================================================
-- 
-- OBJETIVO:
-- Migrar de token único para sistema de access/refresh tokens (OAuth2)
-- Resolve problema crônico de logout ao dar refresh
--
-- MUDANÇAS:
-- - Adiciona colunas: access_token, refresh_token, access_expires_at, refresh_expires_at
-- - Adiciona colunas: rotated_from, rotated_to (para rotação de refresh tokens)
-- - Adiciona colunas: user_agent, ip_hash (para segurança)
-- - Adiciona coluna: revoked_at (para revogação)
-- - Mantém compatibilidade: token antigo vira access_token
-- ============================================================================
...
-- Garantir que refresh_token é único (já tem UNIQUE na coluna, mas índice ajuda)
-- (já criado acima com UNIQUE na coluna)
