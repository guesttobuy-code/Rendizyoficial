-- ============================================================================
-- MIGRATION: Tabela de Automações
-- Data: 2025-11-26
...
CREATE TABLE IF NOT EXISTS automations (
  ...
  name TEXT NOT NULL,
  description TEXT,
  definition JSONB NOT NULL, -- { trigger, conditions, actions, metadata }
  status TEXT NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'active', 'paused')),
  module TEXT, -- financeiro, crm, reservas, chat, operacoes
  channel TEXT, -- chat, whatsapp, email, sms
...
CREATE TABLE IF NOT EXISTS automation_executions (
  ...
  trigger_event TEXT, -- reservation.created, financial.daily_revenue_threshold, etc.
  conditions_met BOOLEAN NOT NULL DEFAULT false,
  actions_executed JSONB, -- Array de ações executadas
  error_message TEXT,
