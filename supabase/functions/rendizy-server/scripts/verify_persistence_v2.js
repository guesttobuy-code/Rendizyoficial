...
// Scripts de Verificação de Persistência (Methodology V2) - JS Version
// Run with: node scripts/verify_persistence_v2.js
...
// Load env vars
const SUPABASE_URL = process.env.LOCAL_SUPABASE_URL || process.env.SUPABASE_URL || "https://odcgnzfremrqnvtitpcc.supabase.co";
const SUPABASE_SERVICE_ROLE_KEY = process.env.LOCAL_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY;

if (!SUPABASE_SERVICE_ROLE_KEY) {
    console.warn("⚠️ AVISO: NENHUMA KEY ENCONTRADA (LOCAL_SERVICE_ROLE_KEY ou SUPABASE_SERVICE_ROLE_KEY)!");
...
async function runTest() {
    console.log("🛡️ INICIANDO PROTOCOLO DE BLINDAGEM - IDENTITY SPOKE (V2.1 JS - Update Focus)");
