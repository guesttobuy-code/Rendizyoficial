  ...
  try {
    const response = await fetch(url, {
      ...
      headers: {
        ...
        'X-Auth-Token': token,
        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1ha2Utc2VydmVyLTY3Y2FmMjZhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE5NzY4MDAsImV4cCI6MjA0NzU1MjgwMH0.8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8qJ8' // Ajuste conforme necessário
      },
      body: JSON.stringify({
